...
nohup bash ~/eRNA/script/step_bam.sh ~/eRNA/mesc/Mesendoderm ~/eRNA/refdata-gex-mm10-2020-A/pos_dELS.bed &
nohup bash ~/eRNA/script/step_bam.sh ~/eRNA/mesc/Germ_layer ~/eRNA/refdata-gex-mm10-2020-A/pos_dELS.bed &
nohup bash ~/eRNA/script/step_bam.sh ~/eRNA/mesc/mix ~/eRNA/refdata-gex-mm10-2020-A/pos_dELS.bed &
